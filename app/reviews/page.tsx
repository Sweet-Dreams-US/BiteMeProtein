      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <ScrollReveal delay={0.1}>
              <a
                href="mailto:bitemeprotein26@gmail.com?subject=Customer%20Review&body=Hi%20Bite%20Me%20team!%20I%20wanted%20to%20share%20my%20experience..."
                className="card-bakery p-8 text-center block hover:shadow-lg transition-all group"
              >
          ...
          <ScrollReveal>
            <div className="card-bakery p-10 md:p-14 text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <a
                  href="mailto:bitemeprotein26@gmail.com?subject=Google%20Review%20Request"
